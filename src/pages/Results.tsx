...
const Results: React.FC = () => {
  ...
  return (
    ...
    <Navbar/>
    <Alert/>
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-6 w-[80vw] mx-auto">
      <div
        className={`w-full rounded-2xl shadow-lg p-8 text-center border ${
          isPositive
      ...
      <button
        ...
        className="mt-6 py-2 px-6 bg-gray-700 text-white rounded-lg text-lg hover:bg-gray-800"
      >
        🔁 Test Again
      </button>
    </div>
