...
export default function Hero(){
    return (
        <div className="w-full h-[75vh] flex flex-col items-center justify-center bg-[url('/src/assets/hero.jpg')] bg-cover bg-center bg-no-repeat">
            <h1 className="mt-20 text-6xl font-bold text-white max-sm:text-3xl text-center">Welcome to Diabetes Risk Predictor</h1>
            <p className="mt-12 text-2xl text-white max-sm:text-xl text-center">Predict your risk of diabetes with our advanced ML model.</p>
