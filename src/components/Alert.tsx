export default function Alert(){
    return(
        <div className="bg-gray-200 border-t-4 border-gray-500 rounded-b text-gray-900 px-4 py-3 shadow-md w-[80vw] mx-auto"   role="alert">
            <div className="flex">
                ...
                <div>
                    ...
                    <p className="text-lg">Our Model`s prediction is not fully acurate.</p>
                </div>
            </div>
         </div> 
